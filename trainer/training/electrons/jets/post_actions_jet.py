...
target_dictionary = {
    ...
    "Electron_dr03EcalRecHitSumEt": [["d", [-np.inf, -2], np.log(1e-3)], ["i", np.exp, [1, 1e-3]]],
    "Electron_dr03HcalDepth1TowerSumEt": [
        ["d", [-np.inf, -2]],
        ["i", np.exp, [1, 1e-3]],
    ],
    "Electron_dr03TkSumPt": [["d", [-np.inf, -2], np.log(1e-3)], ["i", np.exp, [1, 1e-3]]],
    "Electron_dr03TkSumPtHEEP": [["d", [-np.inf, -2], np.log(1e-3)], ["i", np.exp, [1, 1e-3]]],
    ...
    "Electron_miniPFRelIso_all": [["d", [-np.inf, -5.5], np.log(1e-3)], ["i", np.exp, [1, 1e-3]]],
    "Electron_miniPFRelIso_chg": [["d", [-np.inf, -5.5], np.log(1e-3)], ["i", np.exp, [1, 1e-3]]],
    ...
    "Electron_pfRelIso03_chg": [["d", [-np.inf, -5.5], np.log(1e-3) ], ["i", np.exp, [1, 1e-3]]],
