...
def add_args(parser):
    ...
    parser.add_argument('--num_transform_blocks_arqs', type=int, default=4)
    ...
    parser.add_argument('--use_residual_blocks_maf', type=eval, default=True, choices=[True, False])
    ...
    parser.add_argument('--hidden_dim_maf', type=int, default=64)
    parser.add_argument('--hidden_dim_arqs', type=int, default=128)
    ...
    # training options
    parser.add_argument('--n_load_cores', type=int, default=8)
    ...
    parser.add_argument('--hardfix_lr', type=float, default=None,)
