...
def validate(
    ...
    reco = postprocessing(reco, target_dictionary, "scale_factors_muon.json", saturate_ranges_path=None)

    samples = postprocessing(samples, target_dictionary, "scale_factors_muon.json", saturate_ranges_path=None)
